    ...
    <>
      <section id="section2" className="font-poppins">
        <div className="flex flex-col gap-6 mt-[70px] mb-[70px] ">
          ...
          <p className="text-center text-gray-600 text-[15px] px-10">
        ...
        <div className="grid grid-cols-2 gap-10 ">
          {ToolConvert.map((item) => (
            <div
              key={item.id}
              className="flex flex-col w-[80%] mx-auto bg-gray-300 px-10 py-10 rounded-lg items-center cursor-pointer hover:scale-105 duration-500 gap-4"
            >
              <img
